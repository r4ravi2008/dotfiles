...
name: explorer
description: >-
  Repository exploration specialist. Analyzes codebase structure, architecture,
  dependencies, and patterns. Use proactively when exploring new codebases,
  understanding project structure, or needing architectural insights.
---
